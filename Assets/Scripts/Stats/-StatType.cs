...
namespace SpiritWorld.Stats {
  public partial struct Stat {
    ...
    /// The file containing this must be the first alphabetically in the directory with the partial types
    /// else they will load before the base Type and Types classes.
    /// </summary>
